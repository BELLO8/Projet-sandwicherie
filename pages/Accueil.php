                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p style="font-family:  'nautilus_pompiliusregular';font-size:19px;"> 
                            ...
                            est de faire gagner du temps aux clients en leurs permettant de consommer les plats commandés 
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main" src="../assets/images/large_slider_img.jpg" height="410" alt="About Main Image">
                            <img class="about-inset" src="../assets/images/header_bg.jpg" width="160" height="160" alt="About Inset Image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h5 class="title-caption text-center" style="font-weight:600 ;font-family:Arial, Helvetica, sans-serif;">Nous vous offrons une large variété de sandwichs 
                    ...
                    <div class="special-box">
                        ...
                        <?php foreach ($fastfood as $food) :?> 
                            <div class="item item-type-zoom">
                                ...
                                <div class="item-img">
                                    <img src="../Dashboard/upload/food/<?=$food->images ;?>" style="height:300px;width:380;" alt="sp-menu">
                                </div>
                            </div>
                           <?php endforeach ;?>
                        </div>
                        <div class="blog-btn-v" >
                        <a class="hvr-underline-from-center" href="<?=$router->generate('menu');?>" style="border-radius:4px;">Consulter notre menu</a>
                    </div>
                    </div>
                    <!-- end special-box -->
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p class="title-caption text-center" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-weight:bold;">Nous vous donnons la possibilité de créer, et de composer votre propre sandwichs + de 10 combinaisons possibles. </p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <p>Contactez-nous pour touts vos commandes ou renseignements . Nous sommes disponible aussi sur les reseaux sociaux .</p>
                </div>
                <div class="panel-pricing-in">
                    ...
                    <div class="col-md-6 col-sm-6 text-center">
                        <div class="panel panel-pricing">
                            ...
                            <div class="panel-body text-center">
                                <p><strong><span style="font-family: 'nautilus_pompiliusregular';">Contacts</span></strong></p>
                            </div>
                            <p style="font-family: 'nautilus_pompiliusregular';">
                                Contactez-nous aux numeros suivants : 
                            </p>
                            <ul class="list-group">
                                <li class="list-group-item"><i class="fa fa-phone"></i> 09 72 66 46 | <i class="fa fa-phone"></i> 42 03 19 95 | <i class="fa fa-phone"></i> 65 06 90 25 </li>
                                <li class="list-group-item"><i class="fa fa-envelope"></i> alipoegroupentreprise@gmail.com </li>
                            ...
                            <ul>
                                <li class="list-group-item"><i class="fa fa-whatsapp" style="font-size:20px ; color:#0e9017;"></i> Whatsapp</li>
                                <a href="https://www.facebook.com" target="blank"><li class="list-group-item"><i class="fa fa-facebook-square" style="font-size:20px;color:#4c34d2"></i> La sandwicherie chez David</li>                            
                                </a> </ul>
                    ...
                    <div class="col-md-6 col-sm-6 text-center">
                        <div class="panel panel-pricing">
                            ...
                            <div class="panel-body text-center">
                                <p><strong><span style="font-family: 'nautilus_pompiliusregular';">Où nous-sommes ?</span></strong></p>
                            </div>
                            <div>
                                 <p style="font-family: 'nautilus_pompiliusregular';">
