                ...
                <div class="panel-body articles-container">
                    ...
                    <div class="article border-bottom">
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-2 col-md-2 date">
                                    <div class="large">
                                        <h4 style="font-weight:900;font-size:14px;	"><?= $food->prix; ?> CFA</h4>
                                    </div>

                                </div>
                                <div class="col-xs-7 col-md-7">
                                    <h4 style="font-size:15px;font-weight:900;"><a href="" data-toggle="modal"
                                            data-target="#<?= $food->id; ?>"><?= $food->nom; ?></a></h4>
                                    <p style="text-align:left;font-size:11px;font-weight:700;"><?= $food->details; ?>
                                    </p>
                                </div>
                                <div class="col-xs-3 col-md-3">
                                    <img src="upload/food/<?= $food->images; ?>" class="round-image" height="70"
                                        width="70">
                                </div>
                        ...
                        <div class="clear">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="login_form row" action="editfood.php?id=<?= $food->id; ?>"
                                                    id="editfood-<?= $food->id; ?>" method="post"
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input id="name" name="nom"
                                                            value="<?= htmlentities($food->nom); ?>" type="text"
                                                            placeholder="nom du fast food" class="form-control"
                                                            required>
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input id="details" name="details"
                                                            value="<?= htmlentities($food->details); ?>" type="text"
                                                            placeholder="Details" class="form-control" required>
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12">
                                                        ...
                                                        <input name="prix" type="number" value="<?= $food->prix; ?>"
                                                            min="150" max="35000" class="form-control" required>
                                                    ...
                                                    <div class="form-group" style="margin-bottom:22px;">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <img src="upload/food/<?= $food->images; ?>"
                                                                class="round-image col-md-4" height="80" width="80">
                                                        </div>
                                                    </div>
                                                    <!-- Form actions -->
                                                    <input type="submit" class="btn btn-md"
                                                        style="color:white;background-color:#ff0066" value="Modifier">
                            ...
                            <form class="login_form modal row" action="editfood.php?id=<?= $food->id; ?>"
                                id="editfood-<?= $food->id; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input id="name" name="nom" value="<?= htmlentities($food->nom); ?>" type="text"
                                        placeholder="nom du fast food" class="form-control" required>
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input id="details" name="details" value="<?= htmlentities($food->details); ?>"
                                        type="text" placeholder="Details" class="form-control" required>
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input name="prix" type="number" value="<?= $food->prix; ?>" min="150" max="35000"
                                ...
                                <div class="form-group" style="margin-bottom:22px;">
                                    ...
                                    <div class="form-group col-md-6">
                                        <img src="upload/food/<?= $food->images; ?>" class="round-image col-md-4"
                                            height="80" width="80">
                                    </div>
                                </div>
                                <!-- Form actions -->
            ...
            <div class="panel panel-info">
                    ...
                    <ul class="todo-list">
                        ...
                        <li class="todo-list-item">
                            ...
                            <div class="pull-right action-buttons">
                                <form id="delete-<?= $categorie->id; ?>" action="delcat.php?id=<?= $categorie->id; ?>"
                                    method="post">
                                </form>
                                <a class="trash" type="submit" onclick="
																			popup.confirm(
                                ...
                                <form action="editcat.php?id=<?= $categorie->id; ?>" method="post"
                                    class="login_form modal" id="editform-<?= $categorie->id; ?>" style="display:none;">
                                    <h2>Edition de la categorie</h2>
                                    <div class="form-group">
                                        <label>Nom de la categorie</label>
                                        <input class="form-control" name="categorie"
                                            value="<?= $categorie->categorie; ?>" placeholder="Entrer une categorie"
                                            required>
                                    </div>
                ...
                <div class="panel-footer">
                    <form action="" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Ajouter une categorie" name="categorie"
                                required />
                            <span class="">
                                <button class="btn btn-primary btn-md" type="submit" id="btn-todo">Ajouter une
                                    categorie</button>
                            </span>
                        </div>
                    </form>
