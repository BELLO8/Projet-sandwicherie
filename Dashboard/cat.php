...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row" style="margin-bottom:20px;">
        <h2 class="container">Listes des categories <a href="#" data-toggle="modal" data-target="#1" class="btn btn-sm"
                style="color:white;background-color:#ff0066">
                    ...
                    <div class="modal-body">
                        <form action="addcat.php" method="post" class="login_form" id="form1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="categorie" placeholder="Entrer une categorie"
                                    required>
                            </div>

                            <button type="submit" class="btn btn-md"
                                style="color:white;background-color:#ff0066">Ajouter</button>
                        </form>
        ...
        <div class="col-lg-6">
            <div class="panel-heading panel-blue" style="margin-bottom:10px;border-radius:12px;">
                ...
                <a href="" data-toggle="modal" data-target="#editcat<?= $categorie->id; ?>"
                    style="color:#fff;font-size:14px;" class="pull-right">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span></button>
                            <div class="modal-body">
                                <form action="cat.php?id=<?= $categorie->id; ?>" method="post" class="login_form"
                                    id="editform-<?= $categorie->id; ?>">
                                    <h2>Edition de la categorie</h2>
                                    <div class="form-group">
                                        <label>Nom de la categorie</label>
                                        <input class="form-control" name="categorie"
                                            value="<?= htmlentities($categorie->categorie); ?>"
                                            placeholder="Entrer une categorie" required>
                                    </div>
                ...
                <ul class="pull-right panel-settings panel-button-tab-right"
                    ...
                    <a class="trash" type="submit" style="color:#fff;font-size:14px;" onclick="popup.confirm(
									{ 
    ...
    <!--/.row-->
    <h2>Listes des slides <a href="#" data-toggle="modal" data-target="#slide" class="btn btn-sm"
            style="color:white;background-color:#ff0066">
            Ajouter un slide
        </a></h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
                <div class="modal-body">
                    <form class="login_form " id="slide" action="addslide.php" method="post"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="login_form " id="editslide<?= $slider->id; ?>"
                                    action="editslide.php?id=<?= $slider->id; ?>" method="post"
                                    enctype="multipart/form-data">
                                    <h2>Edition du slide</h2>
                                    <div class="form-group">
                                        <label>Texte de slide</label>
                                        <input class="form-control" name="texte"
                                            value="<?= htmlentities($slider->texte); ?>" placeholder="Entrer un texte"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label>Image de slide</label>
                                    ...
                                    <button type="submit" class="btn btn-md"
                                        style="color:white;background-color:#ff0066">Modifier</button>
                                </form>
...
$(function() {
    ...
    }); // ajout d'un bouton pour fermet la fenêtre

    $("#dialogue").dialog({
        draggable: true
    }); // autorise le déplacement de la fenêtre
    $("#dialogue").dialog({
        width: 550
    ...
    $("#dialogue").dialog({
        modal: true
    }); // bloc l'accès aux éléments sous la fenêtre
    $("#dialogue").dialog({
        resizable: true
    ...
    $("#dialogue").dialog({
        show: "slow"
    }); // ajoute une animation à l'ouverture de la fenêtre
